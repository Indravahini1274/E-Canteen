...
<?php
    ...
    // Merge items from hungrymenu and snackmenu into a single array
    $allMenuItems = array_merge($allHungrymenu, $allSnackmenu);
...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <!-- Search bar -->
            <form class="form-inline my-2 my-lg-0" id="menu-search-form">
                <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" id="menu-search-input">
...
<section class="ftco-section ftco-services" style="margin-top: 130px;">
    <div class="container">
        <div class="row">
...
document.addEventListener('DOMContentLoaded', function() {
    // Code for handling 'View Menu' clicks
    ...
    menuSearchForm.addEventListener('submit', function(event) {
        ...
        const allMenuItems = document.querySelectorAll('.menu-items .media-body');

        allMenuItems.forEach(item => {
            const itemName = item.querySelector('h3.heading').innerText.toLowerCase();
            const menuItemDiv = item.parentElement.parentElement;
